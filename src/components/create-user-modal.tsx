    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl h-[96vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Ingrese los datos detallados del nuevo técnico. Los campos marcados con * son obligatorios.
          </DialogDescription>
        </DialogHeader>
        ...
        <Alert variant="default" className="mt-4">
          ...
          <AlertDescription>
            Los campos marcados con * son obligatorios para completar el registro.
          </AlertDescription>
        </Alert>
